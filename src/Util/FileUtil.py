...
class FileUtil:
    ...
    def readAll(file_path):
        ...
        try:
            ...
            with codecs.open(file_path, FileUtil.ACCESS_READ_ONLY) as file:
                lines = file.readlines()
        except Exception as e:
            print(str(e))
            try:
                # support for utf-8 with sig
                with codecs.open(file_path, FileUtil.ACCESS_READ_ONLY, FileUtil.DEFAULT_CODING_WITH_SIG) as file:
                    lines = file.readlines()
    ...
    def writeAll(file_path, line_list, coding=DEFAULT_CODING_WITH_SIG):
        with codecs.open(file_path, FileUtil.ACCESS_WRITE_ONLY, coding) as file:
